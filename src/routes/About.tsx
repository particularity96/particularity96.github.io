            ...
            <section className="bio-section">
                ...
                <div className="bio-text">
                    ...
                    <p>
                        ...
                        Neben diversen kompositorischen Arbeiten schrieb und inszenierte Nic auch das Live-Hörspiel Scherben, komponierte das Musical 'Im Auge des Sturms' und leitete verschiedene studentische Musiktheater-Produktionen. 2019 verbrachte dey vier Monate in Nicosia auf Zypern, wo dey als Musikalische Assistenz von Alex Panayi die Komposition und Uraufführung des Musicals Το παιδί και το δέντρο begleitete. Während des Master-Studiums arbeitete dey vermehrt an dynamischer Musikproduktion für Spiele und leitete den Unichor Bayreuth.<br />
                        Anfang 2023 gründete Nic gemeinsam mit Ruben Schäfer das Studio 'Intellumia' für die Produktion interaktiver, pädagogischer Installationen.<br />
                    </p>
                </div>
            </section>
        </div>
